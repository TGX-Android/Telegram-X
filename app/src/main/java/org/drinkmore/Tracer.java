...
public class Tracer {
  ...
  private static class ClientException_1455 extends RuntimeException {
    private ClientException_1455 (String message) {
      super(format(message));
    }
  }

  private static class DatabaseError extends ClientException_1455 {
    private DatabaseError (String message) {
      super(message + ", versionCode: " + BuildConfig.VERSION_CODE);
    }
  }

  private static class TdlibLaunchError extends ClientException_1455 {
    private TdlibLaunchError (String message) {
      super(message);
    }
  }

  private static class TdlibLostPromiseError extends ClientException_1455 {
  ...
  private static void throwError (Throwable throwable) {
    ...
    if (throwable instanceof ClientException_1455)
      throw (ClientException_1455) throwable;
  ...
  private static void onFatalError (Throwable throwable, @Cause int cause) {
    final class ThrowError implements Runnable {
      ...
      private void throwTestError (Throwable error) {
        throw new ClientException_1455(error.getMessage());
      }
