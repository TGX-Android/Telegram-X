...
public class Tracer {
  ...
  private static class ClientException_1468 extends RuntimeException {
    private ClientException_1468 (String message) {
      super(format(message));
    }
  }

  private static class DatabaseError extends ClientException_1468 {
    private DatabaseError (String message) {
      super(message + ", versionCode: " + BuildConfig.VERSION_CODE);
    }
  }

  private static class TdlibLaunchError extends ClientException_1468 {
    private TdlibLaunchError (String message) {
      super(message);
    }
  }

  private static class TdlibLostPromiseError extends ClientException_1468 {
  ...
  private static void throwError (Throwable throwable) {
    ...
    if (throwable instanceof ClientException_1468)
      throw (ClientException_1468) throwable;
  ...
  private static void onFatalError (Throwable throwable, @Cause int cause) {
    final class ThrowError implements Runnable {
      ...
      private void throwTestError (Throwable error) {
        throw new ClientException_1468(error.getMessage());
      }
