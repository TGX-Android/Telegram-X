...
public class StatsMessagePreviewView extends BaseView implements AttachDelegate, Destroyable, ChatListener, MessageListener, TdlibCache.UserDataChangeListener, TGLegacyManager.EmojiLoadListener {
  ...
  public StatsMessagePreviewView(Context context, Tdlib tdlib) {
    super(context, tdlib);
  ...
  private boolean ignoreRefreshers;

  private TD.ContentPreview contentPreview;

  public void setMessage (@Nullable TdApi.Message message, @Nullable TdApi.SearchMessagesFilter filter, @Nullable String forcedTitle, boolean ignoreAlbumText) {
    this.ignoreRefreshers = ignoreAlbumText;
  ...
  private void buildPreview () {
    ...
    if (!ignoreRefreshers && contentPreview.hasRefresher()) {
