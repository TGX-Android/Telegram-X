...
public class TdlibManager implements Iterable<TdlibAccount>, UI.StateListener {
  ...
  public static void performExternalReply (Context context, CharSequence text, TdlibNotificationExtras extras) {
    ...
    performSyncTask(context, extras.accountId, "reply", (tdlib, onDone) -> {
      tdlib.sendMessage(extras.chatId, extras.messageThreadId, extras.needReply ? new TdApi.InputMessageReplyToMessage(extras.forceExternalReply || tdlib.forceExternalReply(extras.chatId) ? extras.chatId : 0, extras.messageIds[extras.messageIds.length - 1], null) : null, Td.newSendOptions(), new TdApi.InputMessageText(new TdApi.FormattedText(text.toString(), null), null, false), sendingMessage -> {
