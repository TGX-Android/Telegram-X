    ...
    chatSearchAdapter = new SettingsAdapter(this, v -> {
      ...
      switch (listItem.getId()) {
        ...
        case R.id.search_message: {
          ...
          preventLeavingSearchMode();
          tdlib.ui().openChat(TelegramViewController.this, rawMessage.chatId,
            new TdlibUi.ChatOpenParameters().highlightMessage(rawMessage).keepStack().searchQuery(chatSearchManager.getLastQuery()));
          break;
        }
      }
    }, this) {
