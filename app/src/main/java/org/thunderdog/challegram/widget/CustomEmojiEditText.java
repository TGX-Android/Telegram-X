...
public class CustomEmojiEditText extends EmojiEditText implements CustomEmojiSurfaceProvider {
  ...
  public CustomEmojiEditText (Context context, @Nullable Tdlib tdlib) {
    super(context);
    this.tdlib = tdlib;
