...
@Autogenerated private fun isKnownLtrEmoji (codePoint: Int, nextCodePoint: Int): Boolean = if ((codePoint in 0x1f1e6..0x1f200) && (nextCodePoint in 0x1f1e6..0x1f200)) {
  when (codePoint) {
