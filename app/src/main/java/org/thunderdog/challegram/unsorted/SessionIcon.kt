...
fun TdApi.Session.asIcon () = when {
  apiId == 21724 || apiId == 324507 -> R.drawable.baseline_device_android_x
  ...
  containsModel("edg") -> R.drawable.baseline_device_web_edge // Chrome-based Edge names itself as "Edg", while EdgeHTML one is "Edge"
  containsModel("chrome") -> R.drawable.baseline_device_web_chrome
  containsModel("firefox") -> R.drawable.baseline_device_web_firefox
  containsModel("safari") -> R.drawable.baseline_device_web_safari
