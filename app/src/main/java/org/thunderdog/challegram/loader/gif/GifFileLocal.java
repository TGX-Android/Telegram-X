...
public class GifFileLocal extends GifFile {
  ...
  public GifFileLocal (Tdlib tdlib, String path) {
    super(tdlib, TD.newFile(CURRENT_ID--, Integer.toString(CURRENT_ID), path, 1), StringUtils.equalsOrBothEmpty(U.getExtension(path.toLowerCase(Locale.ROOT)), "gif") ? TYPE_GIF : TYPE_MPEG4);
    this.path = path;
  }
