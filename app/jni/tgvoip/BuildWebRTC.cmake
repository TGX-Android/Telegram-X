...
# Source files list:
# https://github.com/TelegramMessenger/Telegram-iOS/blob/ae3ee3d063df2dcde868a50aa6a6bbc8cfd8c63f/third-party/webrtc/BUILD
...
#"${WEBRTC_DIR}/rtc_base/network/received_packet.h"
#"${WEBRTC_DIR}/api/video/i410_buffer.h"
#"${WEBRTC_DIR}/rtc_base/async_dns_resolver.h"
#"${WEBRTC_DIR}/api/legacy_stats_types.h"
#"${WEBRTC_DIR}/api/field_trials_registry.h"
#"${WEBRTC_DIR}/pc/simulcast_sdp_serializer.h"
#"${WEBRTC_DIR}/api/stats/attribute.h"
#"${WEBRTC_DIR}/api/environment/environment.h"
#"${WEBRTC_DIR}/api/location.h"
#"${WEBRTC_DIR}/api/ref_count.h"
#"${WEBRTC_DIR}/common_video/h265/h265_inline.h"
#"${WEBRTC_DIR}/modules/rtp_rtcp/source/frame_object.h"
#"${WEBRTC_DIR}/logging/rtc_event_log/events/rtc_event_log_parse_status.h"
#"${WEBRTC_DIR}/media/base/media_channel_impl.h"
#"${WEBRTC_DIR}/modules/audio_processing/agc2/input_volume_controller.h"
#"${WEBRTC_DIR}/modules/audio_processing/agc2/input_volume_stats_reporter.h"
#"${WEBRTC_DIR}/modules/rtp_rtcp/include/recovered_packet_receiver.h"
#"${WEBRTC_DIR}/modules/rtp_rtcp/source/flexfec_03_header_reader_writer.h"
#"${WEBRTC_DIR}/modules/rtp_rtcp/source/leb128.h"
#"${WEBRTC_DIR}/modules/video_capture/raw_video_sink_interface.h"
#"${WEBRTC_DIR}/modules/video_coding/timing/decode_time_percentile_filter.h"
#"${WEBRTC_DIR}/rtc_base/bitrate_tracker.h"
#"${WEBRTC_DIR}/rtc_base/numerics/sequence_number_unwrapper.h"
#"${WEBRTC_DIR}/rtc_base/strings/str_join.h"
#"${WEBRTC_DIR}/video/frame_dumping_encoder.h"
#"${WEBRTC_DIR}/api/enable_media.h"
#"${WEBRTC_DIR}/logging/rtc_event_log/events/rtc_event_neteq_set_minimum_delay.h"
#"${WEBRTC_DIR}/modules/audio_processing/agc2/speech_level_estimator.h"
#"${WEBRTC_DIR}/p2p/base/stun_dictionary.h"
#"${WEBRTC_DIR}/pc/media_factory.h"
#"${WEBRTC_DIR}/rtc_base/frequency_tracker.h"
#"${WEBRTC_DIR}/api/environment/environment_factory.h"
#"${WEBRTC_DIR}/modules/rtp_rtcp/source/rtp_video_stream_receiver_frame_transformer_delegate.h"
#"${WEBRTC_DIR}/modules/video_coding/timing/inter_frame_delay_variation_calculator.h"
#"${WEBRTC_DIR}/video/receive_statistics_proxy.h"
#"${WEBRTC_DIR}/call/create_call.h"
#"${WEBRTC_DIR}/api/transport/bandwidth_estimation_settings.h"
#"${WEBRTC_DIR}/api/video_codecs/h265_profile_tier_level.h"
#"${WEBRTC_DIR}/modules/rtp_rtcp/source/rtp_packetizer_h265.h"
#"${WEBRTC_DIR}/modules/rtp_rtcp/source/video_rtp_depacketizer_h265.h"
#"${WEBRTC_DIR}/modules/video_coding/include/video_error_codes_utils.h"
#"${WEBRTC_DIR}/modules/rtp_rtcp/source/rtp_packet_h265_common.h"
...
add_library(webrtc STATIC
  ...
  "${WEBRTC_DIR}/rtc_base/bitrate_tracker.cc"
  ...
  "${WEBRTC_DIR}/rtc_base/frequency_tracker.cc"
  ...
  "${WEBRTC_DIR}/rtc_base/network/received_packet.cc"
  "${WEBRTC_DIR}/api/video/i410_buffer.cc"
  "${WEBRTC_DIR}/api/legacy_stats_types.cc"
  "${WEBRTC_DIR}/api/field_trials_registry.cc"
  "${WEBRTC_DIR}/pc/simulcast_sdp_serializer.cc"
  "${WEBRTC_DIR}/stats/attribute.cc"
  "${WEBRTC_DIR}/modules/rtp_rtcp/source/leb128.cc"
  "${WEBRTC_DIR}/api/enable_media.cc"
  "${WEBRTC_DIR}/api/environment/environment_factory.cc"
  "${WEBRTC_DIR}/api/rtp_sender_interface.cc"
  "${WEBRTC_DIR}/modules/audio_processing/agc2/speech_level_estimator.cc"
  "${WEBRTC_DIR}/modules/rtp_rtcp/source/flexfec_03_header_reader_writer.cc"
  "${WEBRTC_DIR}/modules/audio_processing/agc2/input_volume_controller.cc"
  "${WEBRTC_DIR}/modules/audio_processing/agc2/input_volume_stats_reporter.cc"
  "${WEBRTC_DIR}/media/base/media_channel_impl.cc"
  "${WEBRTC_DIR}/p2p/base/stun_dictionary.cc"
  "${WEBRTC_DIR}/call/create_call.cc"
  "${WEBRTC_DIR}/modules/rtp_rtcp/source/frame_object.cc"
  "${WEBRTC_DIR}/modules/video_coding/timing/decode_time_percentile_filter.cc"
  "${WEBRTC_DIR}/logging/rtc_event_log/events/rtc_event_neteq_set_minimum_delay.cc"
  "${WEBRTC_DIR}/modules/video_coding/timing/inter_frame_delay_variation_calculator.cc"
  "${WEBRTC_DIR}/video/frame_dumping_encoder.cc"
  "${WEBRTC_DIR}/modules/rtp_rtcp/source/rtp_video_stream_receiver_frame_transformer_delegate.cc"
  "${WEBRTC_DIR}/video/receive_statistics_proxy.cc"
  "${WEBRTC_DIR}/api/video_codecs/h265_profile_tier_level.cc"
  "${WEBRTC_DIR}/modules/rtp_rtcp/source/rtp_packetizer_h265.cc"
  "${WEBRTC_DIR}/modules/rtp_rtcp/source/video_rtp_depacketizer_h265.cc" 
  "${WEBRTC_DIR}/modules/video_coding/include/video_error_codes_utils.cc"
  "${WEBRTC_DIR}/api/video_codecs/video_decoder_factory.cc"
...
target_sources(webrtc PRIVATE
  ...
  "${WEBRTC_DIR}/modules/video_coding/h26x_packet_buffer.cc"
  ...
  "${WEBRTC_DIR}/net/dcsctp/packet/parameter/zero_checksum_acceptable_chunk_parameter.cc"
...
set(WEBRTC_OPTIONS
  ...
  WEBRTC_OPUS_USE_CODEC_PLC
  WEBRTC_OPUS_SUPPORT_DRED
