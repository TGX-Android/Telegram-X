...
open class GenerateResourcesAndThemesTask : BaseTask() {
  ...
  fun generateResourcesAndThemes () {
    ...
    data class TdConstructor(
      val name: String,
      val ignoredFields: Set<String> = emptySet(),
      val isExperimental: Boolean = false
    )

    val equalTypes = arrayOf(
      TdConstructor("ChatMemberStatus", ignoredFields = setOf(
        "ChatMemberStatusAdministrator.canBeEdited",
        "ChatMemberStatusMember.memberUntilDate"
      )),
      TdConstructor("InternalLinkType", isExperimental = true),
      TdConstructor("InviteLinkChatType"),
      TdConstructor("PollType", isExperimental = true),

      TdConstructor("ProxyType"),
      TdConstructor("InlineKeyboardButtonType"),
      TdConstructor("KeyboardButtonType"),
      TdConstructor("KeyboardButton"),
      TdConstructor("InlineKeyboardButton"),
      TdConstructor("WebAppOpenMode"),
      TdConstructor("ReplyMarkup"),

      TdConstructor("RemoteFile"),
      TdConstructor("LocalFile"),

      TdConstructor("UserStatus"),
      TdConstructor("UserPrivacySettingRule"),
      TdConstructor("Usernames"),

      TdConstructor("DeviceToken"),
      TdConstructor("ReactionType"),
      TdConstructor("BackgroundFill"),
      TdConstructor("Background"),

      TdConstructor("PhotoSize"),
      TdConstructor("Photo"),
      TdConstructor("Animation"),
      TdConstructor("Document"),
      TdConstructor("AnimatedChatPhoto"),
      TdConstructor("Sticker"),
      TdConstructor("SpeechRecognitionResult"),
      TdConstructor("VideoNote"),
      TdConstructor("Video"),
      TdConstructor("Audio"),
      ...
      TdConstructor("ChatAction"),
      TdConstructor("ChatSource"),
      TdConstructor("ChatPhotoStickerType"),
      TdConstructor("ChatPhotoSticker"),
      TdConstructor("ChatFolderIcon"),
      TdConstructor("ChatList"),

      TdConstructor("MaskPosition"),
      TdConstructor("MaskPoint"),
      TdConstructor("Point"),
      TdConstructor("VectorPathCommand"),
      TdConstructor("ClosedVectorPath"),
      TdConstructor("Error"),

      TdConstructor("StickerType"),
      TdConstructor("StickerFormat"),
      TdConstructor("StickerFullType"),
      TdConstructor("ThumbnailFormat"),
      TdConstructor("Thumbnail"),

      TdConstructor("ProfileAccentColors"),
      TdConstructor("ProfileAccentColor"),
      TdConstructor("AccentColor"),
      TdConstructor("ThemeSettings"),

      TdConstructor("CanSendMessageToUserResult"),
      TdConstructor("MessageSelfDestructType"),
      TdConstructor("MessageSender"),
      TdConstructor("TextQuote", isExperimental = true),
      TdConstructor("MessageReplyTo", ignoredFields = setOf(
      ...
      TdConstructor("UpgradedGift", isExperimental = true),
      TdConstructor("UpgradedGiftModel"),
      TdConstructor("UpgradedGiftSymbol"),
      TdConstructor("UpgradedGiftBackdrop"),
      TdConstructor("UpgradedGiftBackdropColors"),
      TdConstructor("UpgradedGiftOriginalDetails", isExperimental = true),
    ...
    fun genConstructorCompare (type: TdConstructor, constructor: String, indent: String): String {
    ...
    writeToFile("vkryl/td/src/main/kotlin/tgx/td/TdEqualsTo.kt") { kt ->
      kt.append("""
        ...
        ${arrayEqualTypes.joinToString("\n\n        ") { typeName ->
          "@Autogenerated\n        " + 
          "fun Array<${typeName}>?.equalsTo(other: Array<${typeName}>?): Boolean = \n        " +
          "  this.contentEqualsOrEmpty(other, ${typeName}::equalsTo)"
        }}
