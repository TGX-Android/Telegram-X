...
open class FetchLanguagesTask : BaseTask() {
  ...
  fun fetchLanguages () {
          ...
          val time = measureTimeMillis {
            ...
            if (!isDefault) {
              ...
              for (outputFolder in outputFolders) {
                writeToFile("app/src/main/res/values-${outputFolder}/strings.xml".compatRelativePath(), true) { xml ->
                  xml.append("""
    ...
    val time = measureTimeMillis {
      writeToFile("app/src/main/res/.gitignore".compatRelativePath()) { gitignore ->
