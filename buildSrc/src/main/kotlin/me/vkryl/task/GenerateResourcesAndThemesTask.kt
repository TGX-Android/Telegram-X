...
open class GenerateResourcesAndThemesTask : BaseTask() {
  ...
  fun generateResourcesAndThemes () {
    ...
    writeToFile("app/src/main/res/values/generated.xml".compatRelativePath()) { xml ->
      xml.append("""
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/core/LangUtils.kt".compatRelativePath()) { kt ->
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/ThemeId.java".compatRelativePath()) { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014-2022 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/ThemeColorId.java".compatRelativePath()) { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014-2022 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/ThemeColorIdTinted.java".compatRelativePath()) { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014-2022 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/PorterDuffThemeColorId.java".compatRelativePath()) { java ->
      java.append("""
        /*
         * This file is a part of Telegram X
         * Copyright © 2014-2022 (tgx-android@pm.me)
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/tool/PorterDuffPaint.kt".compatRelativePath()) { kt ->
      kt.append("""
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/ThemeProperties.kt".compatRelativePath()) { kt ->
      kt.append("""
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/ThemeColors.kt".compatRelativePath()) { kt ->
      kt.append("""
    ...
    writeToFile("app/src/main/res/xml/authenticator.xml".compatRelativePath()) { xml ->
      xml.append("""
        <?xml version="1.0" encoding="utf-8"?>
    ...
    writeToFile("app/src/main/res/xml/syncadapter.xml".compatRelativePath()) { xml ->
      xml.append("""
        <?xml version="1.0" encoding="utf-8"?>
    ...
    writeToFile("app/src/main/java/org/thunderdog/challegram/theme/builtin/ThemeBubbleOverride.kt".compatRelativePath()) { kt ->
      kt.append("""
    ...
    for (entry in themesMap) {
      ...
      writeToFile("app/src/main/java/org/thunderdog/challegram/theme/builtin/Theme${className}.kt".compatRelativePath()) { writer ->
        writer.append("""
